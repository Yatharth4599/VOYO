  ...
  const handleAddAgent = (agent: string) => {
    ...
    const newNode: Node = {
      ...
      data: {
        label: (
          <div
            className="bg-white/80 dark:bg-[#2A1E4D] border-2 border-orange-200 dark:border-purple-400 rounded-2xl p-6 ml-2 mr-2 shadow-xl cursor-grab w-72 relative flex flex-col items-center transition-transform select-none"
          ...
          >
            <div className="text-4xl mb-2">🤖</div> {/* You can customize this icon */}
            ...
            <div className="flex flex-wrap gap-2 mt-2 justify-center">
              <span className="bg-orange-100 dark:bg-purple-900 text-orange-700 dark:text-purple-200 px-2 py-1 rounded text-xs font-semibold">
                VOYO AI
              </span>
            </div>
