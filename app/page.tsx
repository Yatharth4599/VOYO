  ...
  return (
    <>
      ...
      <div className="bg-[#F5F5EB] text-[#1A3A6C] font-satoshi">
        ...
        <header className="bg-gradient-to-br from-[#F5F5EB] to-[#FFF] px-6 pt-24 pb-32 text-center relative overflow-hidden">
          ...
          >
            <h1 className="text-5xl md:text-6xl font-extrabold mb-4 leading-tight">
              Building India's voice-first LLM
            </h1>
        ...
        {/* B2B API Section */}
        <section className="bg-[#1A3A6C] text-white py-24 px-6 text-center">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-4xl font-bold mb-4">VOYO API for Businesses</h2>
            <p className="text-lg mb-6 text-white/80">
              Supercharge your product with VOYO’s voice intelligence. Access our emotional LLM, real-time voice chat,
              and Indian language capabilities through our developer-friendly API.
            </p>
            <ul className="text-left text-white/90 list-disc list-inside mb-8">
              <li>🎧 Integrate VOYO into your IVR and call center workflows</li>
              <li>🌍 Build voice assistants for apps in Hindi, Hinglish & more</li>
              <li>📞 Use Urvashi and other custom agents for sales and support</li>
            </ul>
            <motion.a
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              href="#"
              className="inline-block bg-[#F59F24] text-[#1A3A6C] px-8 py-3 rounded-full font-semibold hover:bg-[#e08a00] transition shadow-lg"
            >
              Explore VOYO API
            </motion.a>
          </div>
