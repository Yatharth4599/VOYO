...
//               <SpotlightCard
//                 key={i}
//                 className="min-w-[320px] max-w-[350px] h-[320px] flex-shrink-0 snap-center custom-spotlight-card rounded-2xl"
...
//                   className="bg- border dark:border-white/20 rounded-2xl p-6 flex flex-col justify-between shadow-xl h-full"
//                 >
//                   <p className="text-lg leading-relaxed mb-6 line-clamp-6">
//                     <span className="font-bold">“{t.quote}”</span>
//                   </p>
            ...
            >
              {testimonials.map((t, i) => (
                <motion.div
                  ...
                  className="min-w-[320px] max-w-[350px] h-[320px] flex-shrink-0 snap-center"
                >
                  <SpotlightCard
                    className="custom-spotlight-card rounded-2xl h-full"
                    spotlightColor="rgba(255, 132, 0, 0.66)"
                  >
                    <div className="bg- border dark:border-white/20 rounded-2xl p-6 flex flex-col justify-between shadow-xl h-full">
                      <p className="text-lg leading-relaxed mb-6 line-clamp-6">
                        <span className="font-bold">“{t.quote}”</span>
                      </p>
                      <div className="flex items-center gap-4 mt-auto">
