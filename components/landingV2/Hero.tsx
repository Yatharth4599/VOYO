...
//           {
//             text: 'Top 150 Github.',
//             desc: 'Our 113.4k stars place us among the most popular projects.',
//             gradient: 'from-yellow-300 to-orange-300 dark:from-black dark:to-rose-950',
//           },
//           {
//             text: '4.9/5 stars on G2.',
//             desc: 'To quote "A solid automation tool that just works."',
//             gradient: 'from-orange-300 to-amber-500 dark:from-rose-950 dark:to-purple-950',
//           },
//           {
//             text: '200k+ community members.',
//             desc: "This wouldn't be possible without you.",
//             gradient: 'from-amber-500 to-yellow-300 dark:from-purple-950 dark:to-black',
//           },
//         ].map((card, i) => (
//           <motion.div
//             key={i}
...
//               ease: 'easeOut',
//             }}
//             className={`bg-gradient-to-r ${card.gradient} text-black dark:text-white text-lg px-4 py-2 rounded hover:opacity-90 transition cursor-pointer`}
//           >
//             <span className="font-bold">{card.text}</span> {card.desc}
//           </motion.div>
//         ))}
//       </div>
